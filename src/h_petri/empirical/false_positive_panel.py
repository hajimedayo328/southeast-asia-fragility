...
def main():
    ...
    bundle = {
        ...
        "honest_limits": (
            ...
            "are serially correlated (effective N < count) — handled by the country-block "
            "bootstrap CIs in false_positive_panel_ci.py (lift CI [1.59,2.19], NtS CI "
            "[0.38,0.57], both excluding 1). A mechanical crash rule "
