...
**作成日**: 2026-05-25
**目的**: 26本のノートを1ページで見渡す。次セッション or 賈先生提出時の「ナビ」。
...
- このINDEXは「俺 (Claude) が次セッションで迷子にならないため」と「賈先生に渡すときの地図」用。
...
| # | ノート | ランク | 一行サマリ |
|---|---|---|---|
| 01 | pitch.md | ★★ | 1ページピッチ (賈先生向けに書いたが、Pages の index.html Hero と重複) |
...
**賈先生に提出するとき**: 「9本の核ノート + Pages 4タブ + Python実装」のセットで全体像が伝わる。
